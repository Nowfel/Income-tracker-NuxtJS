...
export default {
  ...
  getData({ commit }, payload) {
    return this.$axios.get(path + payload)
      .then(response => {
  ...
  deleteData({ commit }, payload) {
    return this.$axios.delete(path + "/" + payload.id)
      .then(response => {
        return response;
      })
  },
  editData({ commit }, payload) {
    return this.$axios.put(path + "/" + payload.id, payload.data)
      .then(response => {
        return response;
      })
  },
  getType({ commit }, payload) {
    return this.$axios.get(typePath + payload)
      .then(response => {
  ...
  saveType({ commit }, payload) {
    return this.$axios.post(typePath, payload)
      .then(response => {
        return response;
      })
  },
  editType({ commit }, payload) {
    return this.$axios.put(typePath + '/' + payload.id, payload.data)
      .then(response => {
        return response;
      })
  },
  deleteType({ commit }, payload) {
    return this.$axios.delete(typePath + '/' + payload.id)
      .then(response => {
        return response;
      })
  },
